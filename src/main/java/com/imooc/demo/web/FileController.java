...
public class FileController {
    ...
    @ResponseBody
    public Result<String> handleFileUpload(HttpServletRequest request) {
        ...
        for (int i = 0; i < files.size(); ++i) {
            ...
            if (!file.isEmpty()) {
                try {
                    ...
                    stream = null;
                    return ResultUtil.error("You failed to upload " + i + " => "
                            + e.getMessage());
                }
            } else {
                return ResultUtil.error("You failed to upload " + i
        ...
        return ResultUtil.success("upload successful");
    }
}
